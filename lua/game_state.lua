...
-- STRICT DOMAIN ISOLATION: Domain A only imports Simulation Configs
...
-- [ARCHITECTURE FIX]: Changed 'float elevation' to 'int32_t elevation'
-- Deterministic fixed-point math MUST be stored as integers to prevent cross-CPU desyncs.
            ...
            if cmd.opcode == 1 then
                ...
                if idx < total_tiles then
                    if state.terrain[p][idx] == 0 then
                        ...
                        -- This now safely stores the scaled integer
